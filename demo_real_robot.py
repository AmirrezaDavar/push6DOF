                ...
                for key_stroke in press_events:
                    if key_stroke == KeyCode(char='q'):
                        ...
                        if click.confirm('Are you sure to drop an episode?'):
                            ...
                            is_recording = False
                        # delete
                    # # gripper control buttons start here # it is connected to gripper class
                    # elif key_stroke == KeyCode(char='o'):
                    #     # Open right jaw
                    #     gripper_controller.open_right_jaw()
                    # elif key_stroke == KeyCode(char='l'):
                    #     # Close right jaw
                    #     gripper_controller.close_right_jaw()
                    # elif key_stroke == KeyCode(char='i'):
                    #     # Open left jaw
                    #     gripper_controller.open_left_jaw()
                    # elif key_stroke == KeyCode(char='k'):
                    #     # Close left jaw
                    #     gripper_controller.close_left_jaw()
